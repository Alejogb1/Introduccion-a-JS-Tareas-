...
const comidasFavoritas = ["pizza", "hamburguesa", "sushi", "lomito", "si"];
...
/*
const comidasFavoritas = ["Pavo", "pollo", "mens"];
let i;
for (  i = 0; i < comidasFavoritas.length; i++){
    console.log("ME gusta muchos el" + comidasFavoritas[0], "y el" + comidasFavoritas[1] + "!!!")
}
