...
// TAREA: Crear 3 variables:
           // var diez = 10;
          //  var tres = 3;
           // var resultadoMultiplicacion = diez * tres;
...
if (operador === "+"){
     var resulado = (sumar(numerocualq1, numerocualq2));
} 
else  {
     var resultado = (restar(numerocualq1, numerocualq2));
};
console.log(resultado);
/*
    'If' - 'Else if' - 'Else'
...
console.log(dividir(), multiplicar());
