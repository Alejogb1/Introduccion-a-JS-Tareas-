...
nuestroTitulo.textContent = "EEEEY Pero como estais? Que os pasa??";
console.log(nuestroTitulo.textContent)
...
const nuestraImagen = document.querySelector("img").src = "img/kittens.jpeg";
...
nuevoLogo.src = "/img/woman_bw.jpg"; // Paja de descargar una imagen asi que uso otra que esta guardada. 
header.appendChild(nuevoLogo);
