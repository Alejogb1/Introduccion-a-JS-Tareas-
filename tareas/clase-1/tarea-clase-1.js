...
function edad(anioActual, aniodeNacimiento) {
        anioActual = window.prompt("Enter the anio actual: ");
        aniodeNacimiento = window.prompt("Enter the aniodeNacimiento: ")
        var resultado1 = anioActual - aniodeNacimiento;
        return alert("your age is: " + resultado1);
}
...
function salarioMensual(salarioAnual){
    salarioAnual = window.prompt("Type your anual wage: ");
    return alert("Your monthly salary is of " + salarioAnual/12);
}
function salarioAnual (salarioMensual){
    salarioMensual = window.prompt("Type your monthly wage: ");
    return alert("Your annual wage is " +salarioMensual*12);
}
function salarioDiario (salariopHora){
    salariopHora = window.prompt("Type your hourly wage: ");
    return alert("Your daily wage is " +salariopHora*24);
}
function salariopHora (salariopMinuto){
    salariopMinuto = window.prompt("Type your wage per minute: ");
    return alert("Your hourly charge is " +salariopMinuto*60);
}
function salariopMinuto (salariopHora){
    salariopHora = window.prompt("Type your hourly charge: ");
    return alert("Your income per minute is " +salariopHora/60);
}
console.log(salarioAnual(), salarioMensual(),  salarioDiario () ,salariopHora (), salariopMinuto())
...
// Variable hoisting -> izar (Lo lleva para arriba, ejemplo de scoping con el var que estaba abajo de console.log()
)
